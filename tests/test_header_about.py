...
class TestHeaderAbout:
    ...
    # Проверка, что отображается раздел "О компани" в шапке сайта
    ...
    # По клику на раздел "О компании", редирект в "Информация о компании"
    ...
    # Проверка, что при наведении на раздел "О компании", появляется выпадающий список
    ...
    # При нажатии на "Дилерам" редирект в раздел "Дилерам"
    ...
    # При нажатии на "Контакты" редирект в раздел "Контакты"

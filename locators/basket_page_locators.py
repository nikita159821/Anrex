...
title_basket = (By.XPATH, "//h1[@class='text-center mb-5']")
text_basket = (By.XPATH, "//div[@class='bx-sbb-empty-cart-text']")
button_shopping = (By.XPATH, "//div[@class='bx-sbb-empty-cart-desc']/a")
payment_in_cash = (By.XPATH, "//div[@class='col column-2']/ul/li[1]")
payment_bank_card = (By.XPATH, "//div[@class='col column-2']/ul/li[2]")
payment_installment = (By.XPATH, "//div[@class='col column-2']/ul/li[3]")
payment_yandex_split = (By.XPATH, "//div[@class='col column-2']/ul/li[4]")
promo_code_input = (By.XPATH, "//section[@class='cart-wrapper']")
promo_code_input_2 = (By.CSS_SELECTOR, '.#coupon-block > div > div.bx-soa-coupon-block > div > input')
